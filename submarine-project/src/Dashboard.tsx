...
import { basesList } from './bases.js';
...
export function Dashboard() {
    ...
    const allBases = Object.values(basesList);

    return (
        <section className="h-screen w-screen items-center bg-gray-700 p-2">
            <div className="mx-auto flex w-7xl flex-col gap-1 rounded-2xl bg-gray-900 p-1">
                ...
                {tab === 'duration' && (
                    <div className="h-190 rounded-xl bg-gray-700">
                        <div className="p-4 text-white">{calculateEstDuration(null)}</div>
                        <div className="m-4 mb-10 bg-gray-700">
                            ...
                            <input
                                onChange={(e) => setMissionDur(e.target.value)}
                                type="range"
                                id="mission-range"
    ...
    function calculateEstDuration(time) {
        if (time === null) {
            ...
            return (
                <div className="flex justify-evenly gap-4 text-3xl">
                    <div className="flex w-1/2 flex-col gap-2">
                        <p>Estimated time on highest velocity</p>
                    ...
                    <div className="flex w-1/2 flex-col gap-2">
                        <p>Estimated time on lowest velocity</p>
                        <div className="flex gap-4 rounded-2xl border-2 border-gray-600 bg-gray-800">
